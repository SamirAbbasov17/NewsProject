...
<div class="col-md-12">
    <div class="white_shd full margin_bottom_30">
        <div class="full graph_head">
            ...
            <a href="<?php echo base_url('create_video')?>"><button type="button" class="btn btn-success pull-right">Create</button></a>
        </div>
        <div class="table_section padding_infor_info">
            <div class="table-responsive-sm">
                <table class="table">
                    ...
                    <tbody>
                    <?php $say = 1; foreach ($get_all_video as $news){ ?>
                        <tr>
                            <td><?php echo $say++?></td>
                            ...
                            <td>
                                <a href="<?php echo base_url('detailVideoAdminNews/'.$news['id'])?>">
                                    <button class="btn btn-warning">Description</button>
                                </a>

                                <a onclick="return confirm('Are you sure ?')" href="<?php echo base_url('deleteVideoAdminNews/'.$news['id'])?>">
                                    <button class="btn btn-danger">Delete</button>
                                </a>
                                <a href="<?php echo base_url('updateVideoAdminNews/'.$news['id'])?>">
