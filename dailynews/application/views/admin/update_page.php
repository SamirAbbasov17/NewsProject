...
<div class="col-md-12">
    <div class="white_shd full margin_bottom_30">
        ...
        <div style="padding: 20px">
            ...
            <form action="<?php echo base_url('updateAct/'.$get_single_news['id'])?>" method="post" enctype="multipart/form-data">
                <br>
                <br>
                <br>
                ...
                <textarea name="desc" id="desc" cols="30" rows="10" class="form-control"><?php echo $get_single_news['description'];?></textarea>
