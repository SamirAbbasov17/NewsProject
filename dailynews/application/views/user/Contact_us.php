    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                <form action="<?php echo base_url('createContactAdminAct')?>" method="post" enctype="multipart/form-data" class="row" id="fh5co_contact_form" >
                    <div class="col-12 py-3">
                        <input type="text" name="name" class="form-control fh5co_contact_text_box" placeholder="Enter Your Name" />
                    </div>
                    <div class="col-6 py-3">
                        <input type="text" name="mail" class="form-control fh5co_contact_text_box" placeholder="E-mail" />
                    </div>
                    <div class="col-6 py-3">
                        <input type="text" name="subject" class="form-control fh5co_contact_text_box" placeholder="Subject" />
                    </div>
                    <div class="col-12 py-3">
                        <textarea name="text" class="form-control fh5co_contacts_message" placeholder="Message"></textarea>
                    </div>
                    <div class="col-12 py-3 text-center"><button type="submit" class="btn contact_btn" onclick="return alert('Muraciyetiniz qeyde alindi')">Send Message</button></div>
                </form>
            </div>
